...
public class Lesson02_producer {
    ...
    public static Properties initConf(){
        ...
        conf.setProperty(ProducerConfig.MAX_REQUEST_SIZE_CONFIG,"1048576"); //1M
        //message.max.bytes


        conf.setProperty(ProducerConfig.BUFFER_MEMORY_CONFIG,"33554432");//32M，消息累加器内存大小
        conf.setProperty(ProducerConfig.MAX_BLOCK_MS_CONFIG,"60000"); //60秒，消息累加器内存满了，业务线程阻塞时间，超时报异常
